...
export const CONTRACT_ABI = [
  ...
  // Events
  'event PoolCreated(uint256 indexed poolId, address indexed creator, address rewardToken, uint256 totalRewards, uint256 duration)',
  'event PoolUpdated(uint256 indexed poolId, uint256 newTotalRewards, uint256 newDuration)',
  'event RewardTokenUpdated(uint256 indexed poolId, address newRewardToken)',
  ...
  'event RewardsClaimed(uint256 indexed poolId, address indexed user, uint256 rewards)',
  'event AutoCompounded(uint256 indexed poolId, address indexed user, uint256 amount)',
  'event ContractRewardsWithdrawn(address token, uint256 amount)',
